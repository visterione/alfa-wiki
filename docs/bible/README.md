...
Подробная техническая документация, написанная как учебник.
Цель — дать полное понимание проекта: как устроен, почему именно так, что происходит под капотом.
...
| [08-modules.md](08-modules.md) | Разбор каждого модуля: отзывы, канбан, чат, курсы и т.д. |
| [09-deployment.md](09-deployment.md) | PM2, деплой, окружение, инфраструктура |
| [10-how-to-add-features.md](10-how-to-add-features.md) | Пошаговый гайд: добавить новый маршрут, модель, страницу |
| [11-patterns-and-pitfalls.md](11-patterns-and-pitfalls.md) | Паттерны кода, типичные ловушки, JS-нюансы |
| [12-troubleshooting.md](12-troubleshooting.md) | Диагностика неполадок: логи, ошибки, SQL-запросы |
