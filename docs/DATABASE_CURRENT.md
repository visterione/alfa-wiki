...
> **Архивный обзор от 04.08.2026.** Актуальная единая документация, построенная
> напрямую по production-схеме от 06.08.2026, находится в
> [`docs/DATABASE_PRODUCTION.md`](DATABASE_PRODUCTION.md). ERD, каталог таблиц
> и словарь полей собраны в одном файле с внутренней навигацией.
