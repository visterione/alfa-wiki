...
const ORG_CLINIC_IDS = {
  'Общество с ограниченной ответственностью «Альфа Престиж»': ['2', '3', '6', '12'], // Альфа, Кидс, Линия, Нео
...
function calcHoursFromTimes(timeFrom, timeTo) {
  ...
  if (mins <= 0) mins += 24 * 60; // overnight / full-day shift (e.g. 21:00–06:00, 08:00–08:00)
  if (mins <= 0) return '';
