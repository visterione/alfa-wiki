...
function makeDocDef(content) {
  return {
    ...
    content,
    styles: {
      docTitle: { fontSize: 9, bold: false, alignment: 'left' },
      hdrName:  { fontSize: 9, bold: true },
      hdrPay:   { fontSize: 10, bold: true },
      hdrInfo:  { fontSize: 8 },
      th:       { fontSize: 6.5, bold: true },
      td:       { fontSize: 7 },
      tdSm:     { fontSize: 6 },
      tdC:      { fontSize: 7, alignment: 'center' },
      tdR:      { fontSize: 7, alignment: 'right' },
      tdBold:   { fontSize: 7, bold: true },
      tdBoldR:  { fontSize: 7, bold: true, alignment: 'right' },
    },
