 ...
 *
 * Второе поколение онбординга, с ver. 8.39 — единственное. Устроен как
 * «Задачи»: слева разделы, справа полотно, один маршрут, экран переключается
 * параметром ?screen= — чтобы ссылка на конкретный экран оставалась рабочей.
 *
