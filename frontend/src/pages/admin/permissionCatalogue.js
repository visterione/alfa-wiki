...
export const ADMIN_SECTIONS = [
  ...
  // Заведение почтовых ящиков и раздача доступа к ним (ver. 8.58). Право
  // открывает только настройку: читать письма оно не позволяет — это решает
  // выданный доступ к конкретному ящику, и ничто другое.
  { key: 'mail', label: 'Почтовые ящики' },
...
/**
 * Маркетинг. У вкладок свои уровни доступа: акции смотрят регистраторы, чтобы
 * отвечать пациенту по телефону,
