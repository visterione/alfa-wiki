 ...
 *
 * Второе поколение онбординга. Первое (таблицы onb_*) жило рядом рабочим, пока
 * сюда не переехали живые заявки, и удалено целиком в ver. 8.39 — общего с ним
 * здесь не было ничего, вплоть до отдельных таблиц под то же самое (файлы, коды
 * на почту, чаты), и именно это сделало удаление одной операцией.
 *
