 ...
 *
 * Свой обход, а не общий со старым онбордингом: у задач были разные таблицы,
 * разные тексты и разный адрес в ссылке. Расчёт себя оправдал — в ver. 8.39
 * первое поколение удалено, и его цикл уехал вместе с ним, не задев этот.
 */
