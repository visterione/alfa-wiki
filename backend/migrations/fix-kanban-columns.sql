-- Исправление структуры таблицы kanban_tasks
-- Если таблица уже создана с неправильными именами колонок, удаляем и пересоздаем

-- Удаляем старую таблицу
DROP TABLE IF EXISTS kanban_tasks CASCADE;

-- Создаем таблицу с правильными именами колонок (camelCase для Sequelize)
...
COMMENT ON COLUMN kanban_tasks."sortOrder" IS 'Порядок сортировки внутри колонки';
