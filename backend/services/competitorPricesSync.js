 ...
 *
 * Название клиники перезаписываем спокойно: колонки сравнений привязаны
 * к id источника, а не к его названию, и переименование в парсере на них
 * больше никак не сказывается.
 */
