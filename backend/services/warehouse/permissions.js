...
const SECTIONS = {
  ...
  reports: {
    ...
    hint: 'read — вкладки «Отчёты» и «Архив», edit — право сохранять снимок отчёта '
      + 'в архив. Какие отчёты внутри — ниже, по одному',
    // Сохранение — не просмотр: снимок видит вся сеть, и класть его в общий
    // список должен тот, кому доверено сказать «эти цифры проверены».
    capability: 'canSaveReports',
  },
};
