 ...
 *
 * Вынесено из services/onboarding/chatLinks.js при появлении второго поколения
 * онбординга: копировать триста строк разговора с чужими сайтами, включая
 * защиту от обращений во внутреннюю сеть, было бы худшим из решений.
 *
