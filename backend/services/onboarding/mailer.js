...
/** Анкета согласована — врачу уходит ссылка на выбор услуг. */
async function sendServicesInvite(app) {
  return send(app.email, 'Анкета врача — выберите услуги', layout('Выберите услуги', `
    <p>Ваша анкета согласована. Остался последний шаг с вашей стороны — отметить услуги, которые вы будете оказывать.</p>
