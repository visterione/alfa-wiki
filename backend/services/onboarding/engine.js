...
/**
 * Согласование запускает независимые ветки: шаги, которые ничего не ждут
 * (создание учётки в МИС, проверка отделом кадров), и выбор услуг врачом. Для
 * показа каталога doctor_id не нужен.
 *
