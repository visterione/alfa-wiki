 ...
 *
 * В интерфейсе эта сущность называется ПОДЗАДАЧЕЙ, в коде и базе — part
 * (TaskPart, task_parts). Переименование ver. 8.46 не пошло дальше надписей:
 * таблица, поля и маршруты /parts остались как были, потому что менять их
 * пришлось бы миграцией ради одного слова. Комментарии написаны про код и
 * говорят «часть» — это то же самое.
 */
