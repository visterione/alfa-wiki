...
/**
 * Сроки в рабочих часах, а не в календарных.
 *
 * Общая служба: файл не знает ни одного модуля — он считает часы по календарю и
 * справочнику праздников. Ею пользуются оба поколения онбординга, и вторая
 * копия этого расчёта разошлась бы с первой на первой же правке рабочего дня.
 *
...
async function holidaySet() {
  ...
  try {
    ...
    console.warn('[workingHours] Не удалось прочитать праздники:', error.message);
